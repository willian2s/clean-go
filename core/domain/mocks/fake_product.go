...
import (
	...
	domain "github.com/willian2s/clean-go/core/domain"
	dto "github.com/willian2s/clean-go/core/dto"
...
// Fetch mocks base method.
func (m *MockProductUseCase) Fetch(paginationRequest *dto.PaginationRequestParams) (*domain.Pagination, error) {
	m.ctrl.T.Helper()
...
// Fetch mocks base method.
func (m *MockProductRepository) Fetch(paginationRequest *dto.PaginationRequestParams) (*domain.Pagination, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Fetch", paginationRequest)
	ret0, _ := ret[0].(*domain.Pagination)
	ret1, _ := ret[1].(error)
