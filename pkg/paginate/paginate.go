...
// Paginate returns a Pagination struct initialized with the given query.
//
// Parameters:
//
//	query (string): The query to be paginated.
//
// Returns:
//
//	Pagination: A Pagination struct initialized with the provided query.
func Paginate(
	query string,
) Pagination {
